package com.example.edvhelper.service.telegrambot.handlers.impl.boteventhandlers.callbackquaryhandler.some;
...
public class NextHandler implements SomeCallbackQueryHandler {
    ...
    @Override
    public CallbackQueryDataEnum availableFor() {
        return CallbackQueryDataEnum.NEXT;
    }
}
