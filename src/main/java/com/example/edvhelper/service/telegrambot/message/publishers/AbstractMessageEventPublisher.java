package com.example.edvhelper.service.telegrambot.message.publishers;
...
public abstract class AbstractMessageEventPublisher {
    ...
    protected CompletableFuture<Message> send(SendPhoto sendPhoto) {
        log.trace("Sending photo: {}", sendPhoto);
        return sendEvent(new MessageEvent(this, sendPhoto));
    }
